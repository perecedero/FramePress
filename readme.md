...
__controller__:  
__(required)__ _The controller used to handle the action_

__function'__:  
__(required)__ _The function used to handle the action_

__is_ajax__:  
__(optional, bool)__ _Especify if this action will be called from the client side_
